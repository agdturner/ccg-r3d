...
public class RenderImage_d {
    ...
    public static void main(String[] args) {
        ...
        run00(args, env, offset, inDataDir, outDataDir);
        run0(args, env, offset, inDataDir, outDataDir);
        run1(args, env, offset, inDataDir, outDataDir);
        runUtah(args, env, offset, inDataDir, outDataDir);
        //runGeographos(args, env, offset, inDataDir, outDataDir);
        runKatrina(args, env, offset, inDataDir, outDataDir);
        runCuriosity(args, env, offset, inDataDir, outDataDir);
        runApollo17(args, env, offset, inDataDir, outDataDir);
        run3dcityloader(args, env, offset, inDataDir, outDataDir);
        runGlacier(args, env, offset, inDataDir, outDataDir);
        runGSHHS(args, env, offset, inDataDir, outDataDir);
    }

    public static void run00(String[] args, V3D_Environment_d env,
            V3D_Vector_d offset, Path inDataDir, Path outDataDir) {
        try {
            /**
             * Renders axes and a flat shape in the edges of a cube aligned with
             * the axes.
             */
...
//                double anglei = 16d;
    ...
    public static void run0(String[] args, V3D_Environment_d env,
            V3D_Vector_d offset, Path inDataDir, Path outDataDir) {
        try {
...
//                double anglei = 16d;
    ...
    public static void run1(String[] args, V3D_Environment_d env,
            V3D_Vector_d offset, Path inDataDir, Path outDataDir) {
        try {
            double epsilon = 1d / 10000000d;
            int n = 1;
...
//                            r.run(size, lighting, ambientLight, castShadow, addGraticules, epsilon);
    ...
    public static void runUtah(String[] args, V3D_Environment_d env,
            V3D_Vector_d offset, Path inDataDir, Path outDataDir) {
        try {
            double epsilon = 1d / 10000000d;
            int n = 1;
            ...
            double scale = 10d;
            Universe_d universe = new Universe_d(env, input,
                    V3D_Vector_d.ZERO, color, assessTopology, epsilon, scale,
                    false);
            // Detail the camera
    ...
    public static void runGSHHS(String[] args, V3D_Environment_d env,
            V3D_Vector_d offset, Path inDataDir, Path outDataDir) {
        try {
//                //double epsilon = 1d / 10000000d;
//                //double epsilon = 1d / 100000000000d;
...
////                }
    ...
    public static void runKatrina(String[] args, V3D_Environment_d env,
            V3D_Vector_d offset, Path inDataDir, Path outDataDir) {
        try {
//            double epsilon = 1d / 10000000d;
//            int n = 10;
...
//                    radius * distance);
//            // Render the image
//            RenderImage_d r = new RenderImage_d(universe, offset, pt, size, zoomFactor, null, epsilon);
//            V3D_Vector_d lighting = new V3D_Vector_d(-1, -2, -3).getUnitVector();
//            String ls = "lighting(i=" + String.format("%,.2f", lighting.dx)
//                    + "_j=" + String.format("%,.2f", lighting.dy)
//                    + "_k=" + String.format("%,.2f", lighting.dz)
...
////                }
    ...
    public static void runCuriosity(String[] args, V3D_Environment_d env,
            V3D_Vector_d offset, Path inDataDir, Path outDataDir) {
        try {
//            double epsilon = 1d / 10000000d;
//            int n = 10;
...
////                }
    ...
    public static void runApollo17(String[] args, V3D_Environment_d env,
            V3D_Vector_d offset, Path inDataDir, Path outDataDir) {
        try {
//            double epsilon = 1d / 10000000d;
//            int n = 10;
...
////                }
    ...
    public static void run3dcityloader(String[] args, V3D_Environment_d env,
            V3D_Vector_d offset, Path inDataDir, Path outDataDir) {
        try {
...
////                }
    ...
    public static void runGlacier(String[] args, V3D_Environment_d env,
            V3D_Vector_d offset, Path inDataDir, Path outDataDir) {
        try {
//            double epsilon = 1d / 10000000d;
//            int n = 10;
